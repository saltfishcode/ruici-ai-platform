...
import type { InterviewSchedule, InterviewFormData, InterviewStatus } from '../types/schedule';
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="w-10 h-10 border-3 border-stone-200 border-t-primary-500 rounded-full animate-spin" />
      </div>
    );
  }
