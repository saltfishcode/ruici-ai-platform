package com.ruici.ai.infrastructure.mapper;
...
public interface ResumeMapper {
    ...
    DocumentAnalysisResponse.ScoreDetail toScoreDetail(ResumeAnalysisEntity entity);
    ...
    @Mapping(target = "simulationStatus", ignore = true)
    ...
    /**
     * 从 DocumentAnalysisResponse 创建 ResumeAnalysisEntity
    ...
    ResumeAnalysisEntity toAnalysisEntity(DocumentAnalysisResponse response);
    ...
    @Mapping(target = "expressionScore", source = "scoreDetail.expressionScore")
    @Mapping(target = "projectScore", source = "scoreDetail.projectScore")
    void updateAnalysisEntity(DocumentAnalysisResponse response, @MappingTarget ResumeAnalysisEntity entity);
