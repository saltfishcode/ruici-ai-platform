package com.ruici.ai.common.aspect;

import com.ruici.ai.common.annotation.RateLimit;
import com.ruici.ai.common.exception.RateLimitExceededException;
...
public class RateLimitAspect {
     ...
     */
    @Around("@annotation(com.ruici.ai.common.annotation.RateLimit) || " +
            "@annotation(com.ruici.ai.common.annotation.RateLimit.Container)")
